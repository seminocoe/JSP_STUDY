...
<div align="center"><b><a href="list.jsp?pageNum=1">글 목록</a>(전체 글:<%=count %>)</b>
<table width="700">
	<tr>
<%if(loginID ==null){ %>
...
%>
	...
	<tr height="30">
		...
		<%} %>
			...
			<a  class="my_text" href="content.jsp?num=<%= article.getNum()%>&pageNum=<%=currentPage%>">
			<%=article.getSubject()%></a>
			
			
			<%if(article.getImageUID() != null){%>
				<img class="my_img" src = "../boardone/img/uploadImg/<%=article.getImageUID()%>.jpg" border="1px" width="150px" height="150px">
			<%}%>
...
%>	
<!-- 검색 창 -->
<form action="list.jsp" name="search" onsubmit="searchSave()">
