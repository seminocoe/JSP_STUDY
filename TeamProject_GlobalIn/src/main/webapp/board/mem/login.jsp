...
<table width="300" border="1">
	...
	<tr>
		...
		<td width="100" align="center">
			<a href="/TeamProject/board/list.bdo">게시판</a>
		</td>
		<td width="100" align="center">
...
<form action="/TeamProject/board/mem/loginProc.bdo" method="post">
<table width="300" border="1" >
	<tr>
	...
	<tr>
		<td colspan="2" align="center">
			...
			onclick="javascript:window.location='/TeamProject/board/list.bdo'">
		</td>
	</tr>
</table>
</form>
