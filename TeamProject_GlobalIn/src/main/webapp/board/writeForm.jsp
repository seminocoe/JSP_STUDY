...
<div align="center"><b>글 쓰기</b><br><br>
	<form action="/TeamProject/board/writePro.bdo" method="post" name="writeForm" onsubmit="return writeSave()" encType = "multipart/form-data">
		...
		<tr>
			<td align="right" colspan="2" bgcolor="${value_c }">
				<a href="/TeamProject/board/list.bdo">글 목록</a>
			</td>
		</tr>
		...
		<tr>
			<td colspan="2" bgcolor="${value_c }" align="center">
				...
				<input type="button" value="목록" onclick="window.location='/TeamProject/board/list.bdo'">
			</td>
		</tr>
		</table>
	</form>
