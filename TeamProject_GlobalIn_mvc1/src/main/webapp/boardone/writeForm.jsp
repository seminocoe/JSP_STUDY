...
<div align="center"><b>글 쓰기</b><br><br>
	<form action="writeProc.jsp" method="post" name="writeForm" onsubmit="return writeSave()" encType = "multipart/form-data">
		...
		<tr>
			...
			<td width="330">
				<input type="text" size="12" maxlength="12" name="writer" readonly="readonly" value="<%=vo.getName()%>">
			</td>
		</tr>
