									...
									<table style="text-align: center; border: 1px solid #dddddd">
										...
										<tr>
											...
											<% 	
												...
												File commentFile = new File(commentReal+"\\"+list.get(i).getImageUID()+".jpg");
												if(list.get(i).getImageUID() != null){
											%>	
											<br><br><img src = "../boardone/img/uploadImg/<%=list.get(i).getImageUID() %>.jpg" border="1px" width="100px" height="100px"><br><br></td>											
										<%}%>	
										</tr>
										</tbody>
									</table>			
